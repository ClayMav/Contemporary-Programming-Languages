...
NODE_DOWNLOAD_URL=https://nodejs.org/dist/v6.11.4/node-v6.11.4-linux-x64.tar.xz
...
NODE_HASH="74e125920e141357bab6ded58198c5f5ee98bf638aaff474ffb355ab699d6a26  node-v6.11.4-linux-x64.tar.xz"

# Where are we?
# -------------

# Before we do any work, let's see if we're running on a 64-bit Linux
# machine.
...
then
    echo "Whoa. What is this place?"
    echo ""
    echo "This doesn't appear to be a 64-bit machine. I quit!"
    echo ""
    echo "And I'm telling on you."
    exit 1
fi
